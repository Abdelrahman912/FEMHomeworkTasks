...
# ╔═╡ df172e1f-6d3b-484f-b2d2-b1d027d06216
using PlutoUI
...
md"### Constitutive Laws (Plane Strain)
$\begin{gather}
\underline{ℂ} = \frac{E}{(1+ν)(1-2ν)} 
\begin{bmatrix}
1-ν & ν & 0 \\
ν & 1-ν & 0 \\
0 & 0 & \frac{1-2ν}{2}
